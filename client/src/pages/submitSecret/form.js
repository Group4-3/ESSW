          ...
          <div className='col-12'>
            ...
            {formData.method === 'publickey' &&
              <div className='row g-3'>
                ...
                <div className='alert alert-light text-danger col-12' role='alert'>It is strongly recommended that the person you are sharing this secret with generates their own key pair and provides you with <i>their</i> public key. Avoid sharing private keys to best maintain security.</div>
              </div>
            }
          </div>
          <div className='col-12'>
